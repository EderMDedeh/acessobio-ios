...
- (void) setupCamera:(BOOL) isSelfie {
    ...
    [self.btTakePic setImage:[UIImage imageNamed:@"ic_takepicture" inBundle:SWIFTPM_MODULE_BUNDLE compatibleWithTraitCollection:nil] forState:UIControlStateNormal];
